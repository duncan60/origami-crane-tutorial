...
export const kabutoSteps: StepDef[] = [
  ...
  {
    title: '往外斜摺出兩支角',
    desc: '把剛才摺上來的兩個尖角分別往左右斜摺出去，超出帽簷——這就是武士帽的兩支角。',
    ops: [
      {
        kind: 'fold',
        a: v2(-0.371, -0.573),
        b: v2(-0.279, 0.623),
        move: v2(-0.04, -0.1),
        layers: { at: v2(-0.04, -0.1), pick: 'top', count: 2 },
        dir: 'up',
        crease: 'valley',
        t0: 0,
        t1: 0.55,
  ...
  {
    title: '前層往上摺出帽簷',
    desc: '下方的尖角現在有前後兩層。只拿最前面那一層往上摺，蓋住兩支角的根部，變成帽簷。',
    ops: [
      {
        kind: 'fold',
        a: v2(-1, -0.85),
  ...
  {
    title: '後層往後收，完成',
    desc: '剩下的後層往後翻摺（傳統摺法是塞進帽子內側，這裡用簡化版）。武士帽完成——戴在指尖上試試。',
    ops: [
      {
        kind: 'fold',
        a: v2(-1, -0.85),
